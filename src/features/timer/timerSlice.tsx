...
import { goToImage, goToNextImage, goToPrevImage, resetImageSlider } from "../imageSlider/imageSliderSlice"
...
export const { setTimerSeconds, setTimerActive, setTimerPause, toggleTimer, resetTime } = timerSlice.actions
