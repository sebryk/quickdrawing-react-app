export const data = {
   ...
   sections: [
      ...
      'We use Your Personal Data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the Privacy Policy Generator (TermsFeed).',
      ...
      'Company (referred to as either "the Company", "We", "Us" or "Our"): Wavetake.',
      ...
      'Personal Data (or "Personal Information"): any information that relates to an identified or identifiable individual. We use "Personal Data" and "Personal Information" interchangeably unless a law uses a specific term.',
      'Service: the Website.',
      ...
      'Website: Wavetake, accessible from http://wavetake.com/.',
      ...
      'Technologies we use may include: Cookies or Browser Cookies (a cookie is a small file placed on Your Device; you can instruct your browser to refuse all Cookies or to indicate when a Cookie is being sent; if You do not accept Cookies, You may not be able to use some parts of our Service). Web Beacons (small electronic files that permit the Company to count users who have visited those pages or opened an email and for other related website statistics).',
      ...
      'Usage Data: Website analytics data (cookies, IP addresses, device identifiers) are retained up to 24 months from the date of collection to analyze trends; server logs (IP addresses, access times) are retained up to 24 months for security monitoring and troubleshooting purposes.',
      ...
      'We may retain Personal Data beyond the periods stated above for different reasons: legal obligation (e.g., financial records for tax authorities), legal claims (to establish, exercise, or defend legal claims), your explicit request, and technical limitations (data exists in backup systems scheduled for routine deletion). You may request information about how long We will retain Your Personal Data by contacting Us.',
      'When retention periods expire, We securely delete or anonymize Personal Data according to the following procedures: deletion (removed from Our systems and no longer actively processed), backup retention (residual copies may remain in encrypted backups for a limited period and are not restored except where necessary for security, disaster recovery, or legal compliance), and anonymization (in some cases, We convert Personal Data into anonymous statistical data that cannot be linked back to You and may be retained indefinitely for research and analytics).',
      ...
      'Contact Us',
      'If you have any questions about this Privacy Policy, You can contact us by email: info@wavetake.com.',
   ],
}
