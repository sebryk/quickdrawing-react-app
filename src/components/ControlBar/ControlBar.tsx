...
import {
   ...
   setIsFinished,
   setProgressIndex,
} from '../../features/imageSlider/imageSliderSlice';
      ...
      >
         <div className="image-slider__control-panel control-panel">
            <div className="control-panel__buttons">
               ...
               >
                  <FaAngleLeft className="control-panel__btn-icon control-panel__btn-icon--prev" />
               </ControlBarBtn>
               <ControlBarBtn className="control-panel__btn" handleClick={() => dispatch(toggleTimer())}>
                  {timer.isActive ? (
               ...
               <ControlBarBtn
                  ...
                  disabled={
                     ...
                     (!imageSlider.isFinished && imageSlider.currentIndex === imageSlider.progressIndex)
                  }
               >
                  <FaAngleRight className="control-panel__btn-icon control-panel__btn-icon--next" />
               </ControlBarBtn>
               <ControlBarBtn className="control-panel__btn" handleClick={resetSession}>
                  <TbReload className="control-panel__btn-icon control-panel__btn-icon--reset" />
               </ControlBarBtn>
            </div>
         </div>
         <div
            className="control-panel__timer"
            style={{
